...
!function (e, t) {
  'object' == (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) && 'object' == (typeof module === 'undefined' ? 'undefined' : _typeof(module)) ? module.exports = t() : 'function' == typeof define && define.amd ? define('DPlayer', [], t) : 'object' == (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) ? exports.DPlayer = t() : e.DPlayer = t();
}(window, function () {
  return function (e) {
    var t = {};
    function n(i) {
    ...
    return n.m = e, n.c = t, n.d = function (e, t, i) {
      ...
      var i = Object.create(null);
      if (n.r(i), Object.defineProperty(i, 'default', { enumerable: !0, value: e }), 2 & t && 'string' != typeof e) for (var a in e) {
        n.d(i, a, function (t) {
          return e[t];
        }.bind(null, a));
      }return i;
    ...
    function u(e, t) {
      if (null !== e && void 0 !== e) if ('object' !== (void 0 === e ? 'undefined' : i(e)) && (e = [e]), s(e)) for (var n = 0, a = e.length; n < a; n++) {
        t.call(null, e[n], n, e);
      } else for (var o in e) {
    ...
    var i = /mobile/i.test(window.navigator.userAgent),
      ...
      setScrollPosition: function setScrollPosition(e) {
        var t = e.left,
            n = void 0 === t ? 0 : t,
            i = e.top,
            a = void 0 === i ? 0 : i;
      ...
      color2Number: function color2Number(e) {
        return '#' === e[0] && (e = e.substr(1)), 3 === e.length && (e = '' + e[0] + e[0] + e[1] + e[1] + e[2] + e[2]), parseInt(e, 16) + 0 & 16777215;
      },
      number2Color: function number2Color(e) {
        return '#' + ('00000' + e.toString(16)).slice(-6);
      },
      number2Type: function number2Type(e) {
        switch (e) {
          case 0:
            return 'right';
          case 1:
    ...
    var l = function () {
      ...
      return i(e, [{
        ...
        value: function value() {
          var e = this,
              t = function t(_t) {
            var n = ((_t.clientX || _t.changedTouches[0].clientX) - a.default.getElementViewLeft(e.player.template.playedBarWrap)) / e.player.template.playedBarWrap.clientWidth;
    ...
    var l = function () {
      function e(t) {
        !function (e, t) {
          if (!(e instanceof t)) throw new TypeError('Cannot call a class as a function');
        }(this, e), this.options = t, this.container = this.options.container, this.danTunnel = { right: {}, top: {}, bottom: {} }, this.danIndex = 0, this.dan = [], this.showing = !0, this._opacity = this.options.opacity, this.events = this.options.events, this.unlimited = this.options.unlimited, this._measure(''), this.load();
      }
      return o(e, [{
        key: 'load',
        value: function value() {
        ...
        key: '_readAllEndpoints',
        value: function value(e, t) {
          for (var n = this, i = [], a = 0, o = function o(_o) {
            n.options.apiBackend.read({
              url: e[_o],
              success: function success(n) {
                i[_o] = n, ++a === e.length && t(i);
              },
              error: function error(r) {
                n.options.error(r || n.options.tran('Danmaku load failed')), i[_o] = [], ++a === e.length && t(i);
              }
            });
          }, r = 0; r < e.length; ++r) {
            o(r);
          ...
          if (this.showing) {
            var n = this.options.height,
              ...
              return (i + e) / 5;
                ...
                u = function u(e, n, o) {
              for (var s = i / c(o), u = function u(a) {
                var o = t.danTunnel[n][a + ''];
            ...
            for (var d = document.createDocumentFragment(), p = function p(a) {
    ...
    var i = n(0);
    e.exports = i.isStandardBrowserEnv() ? {
      write: function write(e, t, n, a, o, r) {
        var s = [];
      ...
      !function (e, n) {
        if (!e.setImmediate) {
          var i,
              ...
              d = e.document,
              p = Object.getPrototypeOf && Object.getPrototypeOf(e);
          p = p && p.setTimeout ? p : e, '[object process]' === {}.toString.call(e.process) ? i = function i(e) {
            t.nextTick(function () {
              f(e);
            });
          } : !function () {
            ...
            o.port2.postMessage(e);
          }) : d && 'onreadystatechange' in d.createElement('script') ? (a = d.documentElement, i = function i(e) {
            var t = d.createElement('script');
            t.onreadystatechange = function () {
            ...
            setTimeout(f, 0, e);
          } : (r = 'setImmediate$' + Math.random() + '$', s = function s(t) {
      ...
      return i(e, [{
        ...
        value: function value() {
          ...
          if (this.paused = !1, this.video.paused && this.bezel.switch(c.default.play), this.template.playButton.innerHTML = c.default.pause, a.default.resolve(this.video.play()).catch(function () {
            e.pause();
          }).then(function () {}), this.timer.enable('loading'), this.container.classList.remove('dplayer-paused'), this.container.classList.add('dplayer-playing'), this.danmaku && this.danmaku.play(), this.options.mutex) for (var t = 0; t < M.length; t++) {
            this !== M[t] && M[t].pause();
          }
        }
      }, {
        ...
        key: 'switchVolumeIcon',
        value: function value() {
          this.volume() >= 0.95 ? this.template.volumeIcon.innerHTML = c.default.volumeUp : this.volume() > 0 ? this.template.volumeIcon.innerHTML = c.default.volumeDown : this.template.volumeIcon.innerHTML = c.default.volumeOff;
        }
      }, {
        key: 'volume',
        value: function value(e, t, n) {
        ...
        value: function value(e, t) {
          ...
          this.initMSE(e, t), this.on('durationchange', function () {
            ...
            n.tran && n.notice && (n.type, n.notice(n.tran('Video load failed'), -1));
          }), this.on('ended', function () {
